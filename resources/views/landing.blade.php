    ...
    <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3 col-6">
                            <a href="{{ route('listings.all', 'needrooms') }}" class="gr-sb gr-active">Room </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="{{ route('listings.all', 'needapartments') }}" class="gr-sb">Entire Place </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="{{ route('listings.all', 'offerrooms') }}" class="gr-sb">Roommate </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="{{ route('listings.all', 'offerapartments') }}" class="gr-sb">Tenant </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control gr-text" id="inlineFormInputGroup"
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image: url({{ asset('frontend/images/sld6.jpg') }})">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="display-5 text-light">Choose to live with <span class="gr-text-yellow">like-minded
                            </span>people.</h2>
                    </div>
                </div>
                <!-- Slide Two - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image: url({{ asset('frontend/images/sld2.jpg') }})">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="display-5 text-light">Wherever you are <span class="gr-text-yellow">192 countries
                            </span> & 18 languages.</h2>

                    </div>
                </div>
                <!-- Slide Three - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image: url({{ asset('frontend/images/sld3.jpg') }})">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="display-5 text-light">Live together with people who will<span class="gr-text-yellow">
                                inspire you.</span></h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="gr-ct-lst">
                        ...
                        <div class="row">
                            <div class="col-3 mb-3 same">
                                <a href="#">
                                    <div class="city-box">
                                        <img src="{{ asset('frontend/images/sld1.jpg') }}">
                                        <div class="content">
                                            <h2>New York</h2>
                                            <div class="overlay"></div>
                                            <h3><i class="fab fa-searchengin"></i> New york Listings</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-3 mb-3 same">
                                <a href="#">
                                    <div class="city-box">
                                        <img src="{{ asset('frontend/images/sld2.jpg') }}">
                                        <div class="content">
                                            <h2>Paris</h2>
                                            <div class="overlay"></div>
                                            <h3> <i class="fab fa-searchengin"></i>Paris Listings</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    <img src="{{ asset('frontend/images/sld3.jpg') }}">
                                    <div class="content">
                                        <h2>Istanbul</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Istanbul Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    <img src="{{ asset('frontend/images/sld4.jpg') }}">
                                    <div class="content">
                                        <h2>Sao Paulo</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Sao Paulo Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    <img src="{{ asset('frontend/images/sld5.jpg') }}">
                                    <div class="content">
                                        <h2>London</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> London Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    <img src="{{ asset('frontend/images/sld6.jpg') }}">
                                    <div class="content">
                                        <h2>Rome</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Rome Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    <img src="{{ asset('frontend/images/sld7.jpg') }}">
                                    <div class="content">
                                        <h2>Miami</h2>
                                        <div class="overlay"></div>
                            ...
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    <img src="{{ asset('frontend/images/sld8.jpg') }}">
                                    <div class="content">
                                        <h2>Tokyo</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Tokyo Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    ...
                                    <div class="content">
                                        <h2>Amsterdam</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Amsterdam Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                            ...
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    ...
                                    <div class="content">
                                        <h2>Moscow</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Moscow Listings</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 mb-3 same">
                                <div class="city-box">
                                    ...
                                    <div class="content">
                                        <h2>Singapore</h2>
                                        <div class="overlay"></div>
                                        <h3> <i class="fab fa-searchengin"></i> Singapore Listings</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="gr-about-us">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque blanditiis sint incidunt ipsa
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-box">
                        ...
                        <p>Connect with users using Roomster mailbox and Social connect.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-box">
                        ...
                        <h2>Find a home</h2>
                        <p>Search listings in 192 countries and 18 languages</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-box">
                        ...
                        <h2>Pets</h2>
                        <p>Use search filters to find places and people that are pet friendly</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="grs ">
                            <div class="row">
                                <div class="col-md-5 mx-auto mt-3">
                                    ...
                                    <div class="box"><i class="fab fa-vimeo-v f16"></i></div>
                                    <div class="box"><i class="fab fa-youtube f16"></i></div>
                                    <div class="box"><i class="fab fa-pinterest f16"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <nav class="nav gr-city-nav">
                                        <li class="nav-link"><a href="#">Amsterdam</a></li>
                                        ...
                                        <li class="nav-link"><a href="#">Bangkok</a></li>
                                        <li class="nav-link"><a href="#">Barcelona</a></li>
                                        <li class="nav-link"><a href="#">Berlin</a></li>
                                        <li class="nav-link"><a href="#">Boston</a></li>
                                        <li class="nav-link"><a href="#">Chicago</a></li>
                                        <li class="nav-link"><a href="#">Copenhagen</a></li>
                                        <li class="nav-link"><a href="#">Dallas</a></li>
                                        <li class="nav-link"><a href="#">Delhi</a></li>
                                        <li class="nav-link"><a href="#">Denver</a></li>
                                        <li class="nav-link"><a href="#">Dubai</a></li>
                                        <li class="nav-link"><a href="#">Essen, Düsseldorf</a></li>
                                        <li class="nav-link"><a href="#">Houston</a></li>
                                        <li class="nav-link"><a href="#">Istanbul</a></li>
                                        <li class="nav-link"><a href="#">Jakarta</a></li>
                                        <li class="nav-link"><a href="#">Johannesburg</a></li>
                                        <li class="nav-link"><a href="#">Kiev</a></li>
                                        <li class="nav-link"><a href="#">Las Vegas</a></li>
                                        <li class="nav-link"><a href="#">London</a></li>
                                        <li class="nav-link"><a href="#">Los Angeles</a></li>
                                        <li class="nav-link"><a href="#">Madrid</a></li>
                                        <li class="nav-link"><a href="#">Manila</a></li>
                                        <li class="nav-link"><a href="#">Melbourne</a></li>
                                        <li class="nav-link"><a href="#">Mexico City</a></li>
                                        <li class="nav-link"><a href="#">Miami</a></li>
                                        <li class="nav-link"><a href="#">Moscow</a></li>
                                        <li class="nav-link"><a href="#">Mumbai</a></li>
                                        <li class="nav-link"><a href="#">Naples</a></li>
                                        <li class="nav-link"><a href="#">New York City</a></li>
                                        <li class="nav-link"><a href="#">Orlando</a></li>
                                        <li class="nav-link"><a href="#">Osaka, Kobe, Kyoto</a></li>
                                        <li class="nav-link"><a href="#">Paris</a></li>
                                        <li class="nav-link"><a href="#">Philadelphia</a></li>
                                        <li class="nav-link"><a href="#">Portland</a></li>
                                        <li class="nav-link"><a href="#">Rome</a></li>
                                        <li class="nav-link"><a href="#">SF Bay Area</a></li>
                                        <li class="nav-link"><a href="#">San Diego</a></li>
                                        <li class="nav-link"><a href="#">Sao Paulo</a></li>
                                        <li class="nav-link"><a href="#">Seattle</a></li>
                                        <li class="nav-link"><a href="#">Seoul</a></li>
                                        <li class="nav-link"><a href="#">Singapore</a></li>
                                        <li class="nav-link"><a href="#">St Petersburg</a></li>
                                        <li class="nav-link"><a href="#">Sydney</a></li>
                                        <li class="nav-link"><a href="#">Taipei</a></li>
                                        <li class="nav-link"><a href="#">Tokyo</a></li>
                                        <li class="nav-link"><a href="#">Toronto</a></li>
                                        <li class="nav-link"><a href="#">Vancouver</a></li>
                                        <li class="nav-link"><a href="#">Warsaw</a></li>

...
<script>
    ...
    export default {
        ...
        methods: {
            formSubmitted(){
                this.formData.put(`/offerrooms/${this.formData.listing_id}`)
                    .then(({ data }) => { 
            ...
            setFormData(listing){
                ...
                this.formData.move_in_fee = listing.move_in_fee;
                this.formData.utility_cost = listing.utility_cost;
                this.formData.parking_rent = listing.parking_rent;
                this.formData.is_furnished = listing.is_furnished;

                this.formData.amenities = listing.amenities ? listing.amenities.split(',') : [];

                this.formData.household_age = listing.household_age.split(',');
                this.formData.people_in_household = listing.people_in_household;
                this.formData.household_sex = listing.household_sex;

                this.formData.cleanliness =listing.cleanliness;
                this.formData.overnight_guest =listing.overnight_guest;
                this.formData.party_habit =listing.party_habit;
                this.formData.get_up =listing.get_up;
                this.formData.go_to_bed =listing.go_to_bed;
                this.formData.food_preference =listing.food_preference;
                this.formData.smoker =listing.smoker;
                this.formData.work_schedule =listing.work_schedule;
                this.formData.occupation =listing.occupation;

                this.formData.prefer_age = listing.prefer_age.split(',');
                this.formData.prefer_smoker = listing.prefer_smoker;
                this.formData.prefer_student = listing.prefer_student;

                this.formData.household_pets = listing.household_pets ? listing.household_pets.split(',') : [];
                this.formData.prefer_pets = listing.prefer_pets ? listing.prefer_pets.split(',') : [];

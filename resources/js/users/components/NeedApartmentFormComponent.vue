<template>
  <div class="content">
    <form
      ...
      @keydown="formData.onKeydown($event)"
    >
            ...
            <div class="row">
              <div class="col-12">
                <div class="basic-form mb-4">
                  <button
                    class="btn btn-success w-md-25 mr-3 btn-lg"
                  ...
                  <div class="card shadow-none border-0 rounded-0 p-md-4">
                    <div class="card-body">
                      <div class="form-group">
                        <label
                          for="title"
                          class="label font-20 text-muted font-weight-bold"
                        >Headline</label>
                        <input
                          id="title"
                          name="title"
                      ...
                      <div class="form-group row">
                        <div class="col-md-6">
                          ...
                          <v-select :options="['USD']" v-model="formData.rental_currency"></v-select>
                  ...
                  <div class="card shadow-none border-0 rounded-0 p-md-4">
                    <div class="card-body">
                      ...
                      <div class="form-row">
                        <div
                          class="col-6"
                          v-for="apartment in storeData.apartmentTypes"
                          :key="apartment.name"
                        >
                      ...
                      <div class="form-row">
                        <div
                          class="col-6"
                          v-for="amenity in storeData.apartmentAmenities"
                          :key="amenity.name"
                        >
                          <div class="custom-control custom-checkbox">
                            <input
...
export default {
  ...
  methods: {
    formSubmitted() {
      this.formData.post("/needapartments").then(({ data }) => {
